    ...
    <div className={styles.answerRecordTable}>
      ...
      {answerRecord.map(singleAnswer =>
        <div key={singleAnswer.country} className={styles.singleRow}>
          <div className={styles.col1Layout} data-testid={`${singleAnswer.country}-col1-record`}>
            {singleAnswer.country}
          </div>
          <div className={styles.col2Layout} data-testid={`${singleAnswer.country}-col2-record`}>
            {singleAnswer.capital}
          </div>
          <div className={styles.col3Layout} data-testid={`${singleAnswer.country}-col3-record`}>
